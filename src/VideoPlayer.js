...
//   const [screenshots, setScreenshots] = useState([screenshotDict]);
//   const refs = useRef({
//     video: null,
//     loader: null,
//     numberInput: null,
...
//     var screenshotHolder = canvasCapture(canvas, ctx, playerRef);
//     setScreenshots((screenshots) => [...screenshots, screenshotHolder]);
//     // var tempTimestamp = playerRef.current.getCurrentTime();
//     // setScreenshots((screenshots) => [
//     //   ...screenshots,
//     //   { screenshotHolder, tempTimestamp },
//     // ]);
//     //screenshotDict.screenshotHolder = tempTimestamp;
//     //console.log("screenshotHolder" in screenshotDict);
//   };
...
//             <button id="screenshotButton" onClick={handleScreenshots}>
//               <FaCamera size={40} />
//             </button>
...
//             <section onClick={handleSeekTo(screenshot.tempTimestamp)}>
//               {screenshot.canvas}
//             </section>;
//           })}
//         </div>
